...
let%test "test8_f_x_1" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("x", 1)  ( 3,  "LB")

let%test "test8_f_y_1" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("y", 1)  ( 4,  "LB")
    
let%test "test8_f_z_1" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("z", 1)  ( 6,  "LB")
  
let%test "test8_f_x_2" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("x", 2)  ( 7,  "LB")
    
let%test "test8_f_y_2" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("y", 2)  ( 8,  "LB")
    
let%test "test8_f_z_2" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("z", 2)  ( 10,  "LB")
  
let%test "test8_f_x1" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("x1", 1)  ( 7,  "LB")
    
let%test "test8_f_y1" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("y1", 1)  ( 8,  "LB")
    
let%test "test8_f_z1" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("z1", 1)  ( 10,  "LB")
    
let%test "test8_f_a" = 
  test (pathFichiersRat^"test8.rat")  "f@Int" ("a", 1)  ( (-1),  "LB")
    
let%test "test9_f_a" = 
  test (pathFichiersRat^"test9.rat")  "f@Int" ("a", 1)  ( (-1),  "LB")

let%test "test10_f_a" = 
  test (pathFichiersRat^"test10.rat")  "f@Rat" ("a", 1)  ( (-2),  "LB")

let%test "test11_f_a" = 
  test (pathFichiersRat^"test11.rat")  "f@Bool" ("a", 1)  ( (-1),  "LB")
    
let%test "test12_f_b" = 
  test (pathFichiersRat^"test12.rat")  "f@Int@Rat@Bool" ("b", 1)  ( (-4),  "LB")
    
let%test "test12_f_r" = 
  test (pathFichiersRat^"test12.rat")  "f@Int@Rat@Bool" ("r", 1)  ( (-3),  "LB")
    
let%test "test12_f_i" = 
  test (pathFichiersRat^"test12.rat")  "f@Int@Rat@Bool" ("i", 1)  ( (-1),  "LB")
